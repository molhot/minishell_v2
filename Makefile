...
SRCS	=	tokenizer/tokenizer.c tokenizer/create_token.c\
			...
			expand/expand_simplecommand.c expand/expand_redirection.c expand/remake_token.c expand/quote_manage.c expand/doller_manage.c expand/expand_specialparam.c\
